...
import {
  ...
  SimpleUserDelegate,
  SimpleUserMedia,
  SimpleUserMediaConstraints,
  SimpleUserMediaLocal,
...
export type ToIPMediaLocal = SimpleUserMediaLocal;
export type ToIPUserMediaRemote = SimpleUserMediaRemote;
export type ToIPOptions = SimpleUserOptions;
export type ToIPDelegate = SimpleUserDelegate;
